...
`C:\Users\<user>\.claude\settings.local.json` had two defects:
...
```json
"command": "\"C:\\Program Files\\Git\\bin\\bash.exe\" \"C:\\Users\\<user>\\.claude\\skills\\continuous-learning\\hooks\\observe-wrapper.sh\""
```
...
```json
"command": "C:\\Users\\<user>\\.claude\\skills\\continuous-learning\\hooks\\observe.sh"
```
...
`C:\Users\<user>\.claude\settings.local.json` rewritten as UTF-8 (no BOM), LF
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "C:/Users/<user>/.claude/skills/continuous-learning/hooks/observe-wrapper.sh post"
          }
        ]
      }
    ]
...
echo '{"tool_name":"Bash","tool_input":{"command":"pwd"},"session_id":"post-fix-verify-001","cwd":"...","hook_event_name":"PostToolUse"}' \
  | "C:/Users/<user>/.claude/skills/continuous-learning/hooks/observe-wrapper.sh" post
# exit=0

# PreToolUse path
echo '{"tool_name":"Bash","tool_input":{"command":"ls"},"session_id":"post-fix-verify-pre-001","cwd":"...","hook_event_name":"PreToolUse"}' \
  | "C:/Users/<user>/.claude/skills/continuous-learning/hooks/observe-wrapper.sh" pre
# exit=0
```
...
- `C:\Users\<user>\.claude\settings.local.json` — rewritten
- `C:\Users\<user>\.claude\settings.local.json.bak-hookfix-20260421-145718` — pre-fix backup
