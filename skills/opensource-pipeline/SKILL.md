...
description: "Use when open-source pipeline: fork, sanitize, and package private projects for safe public release. Chains 3 agents (forker, sanitizer, packager). Triggers: '/opensource', 'open source this', 'make this public', 'prepare for open source'. Triggers on \"opensource-pipeline\", \"opensource pipeline\", \"pipeline\"."
metadata:
  origin: ECC
---
