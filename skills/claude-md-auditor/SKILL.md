...
description: Use when auditing CLAUDE.md length and structure — trims, path-specific rules, HTML comments, prompt-for-next-session. Triggers on "claude md auditor", "claude md trim", "claude md path specific rules", "doctor claude", "/doctor".
metadata:
  origin: AUTORAL
  source_docs:
