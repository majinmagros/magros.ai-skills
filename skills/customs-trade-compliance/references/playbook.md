# Playbook — Customs & Trade Compliance

Conhecimento operacional completo: classificação HS, documentação, Incoterms, duty optimization, screening, regiões, penalidades, frameworks de decisão, edge cases, comunicação, escalação, KPIs.
...
**Escalation chain:** Level 1 (Analyst) → Level 2 (Trade Compliance Manager, 4 hours) → Level 3 (Director of Compliance, 24 hours) → Level 4 (VP Trade Compliance, 48 hours) → Level 5 (General Counsel / C-suite, immediate for seizures, SDN matches, or penalty exposure > $100K)
