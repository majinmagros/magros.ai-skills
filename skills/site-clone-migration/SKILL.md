...
- Hotlinking source assets -> breaks on deploy.
- Calling it done without a side-by-side diff.
- Migrating WordPress content without slug redirects.

## Relations

- `browser-qa`: screenshot capture and visual verification loop.
- `e2e-testing`: route checks and regression after migration.
- `frontend-patterns`: React/Next component structure and state rules.
- `cloud-design-prototyping`: use instead for new design, not cloning.
- `seo`: redirect and metadata checks on migrated routes.

## Sources

- Playwright docs (screenshots, viewports): https://playwright.dev
- Next.js docs (app routing, build): https://nextjs.org/docs
- Tailwind CSS docs (tokens, responsive): https://tailwindcss.com/docs
- TypeScript docs: https://www.typescriptlang.org/docs/
- Counts and tool behavior from the source video (for example asset
  totals and parallel-agent setup) are author measurement, not benchmarks.
  Do not quote them as facts.
