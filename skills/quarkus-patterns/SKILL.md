...
description: "Use when quarkus 3.x LTS architecture patterns with Camel for messaging, RESTful API design, CDI services, data access with Panache, and async processing. Use for Java Quarkus backend work with event-driven architectures. Triggers on \"quarkus-patterns\", \"quarkus patterns\", \"patterns\"."
metadata:
  origin: ECC
---
