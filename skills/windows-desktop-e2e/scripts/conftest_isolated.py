# conftest_isolated.py — Tier 1 filesystem isolation (default, always use).
# Replaces the basic `app` fixture: fresh process + isolated APPDATA/LOCALAPPDATA/TEMP per test.
# Extraído de SKILL.md (2026-09-09). Renomeie para conftest.py ao adotar.
