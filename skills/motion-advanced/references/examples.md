# Examples — Motion Advanced (código completo)

Todos os exemplos de código: drag, gestures, text, SVG, hooks, loaders, infinite + end-to-end. Princípios e regras no `SKILL.md`.
