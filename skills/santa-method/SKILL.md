---
name: santa-method
description: "Use when multi-agent adversarial verification with convergence loop. Two independent review agents must both pass before output ships. Triggers on \"santa-method\", \"santa method\", \"method\"."
metadata:
