...
2. **Coherence beats novelty.** One look executed across 30 shots beats 30 looks. A named
   genre (see `genre-taxonomy.md`) is a constraint that buys coherence for free.
3. **Cut to the song, not to the footage.** In a music video the timeline is the waveform.
   Every hard cut lands on a beat or a transient.
...
`genre-taxonomy.md`. The useful move is not memorizing 70 names — it is seeing
