...
description: "Use when apple FoundationModels framework for on-device LLM — text generation, guided generation with @Generable, tool calling, and snapshot streaming in iOS 26+. Triggers on \"foundation-models-on-device\", \"foundation models on device\", \"device\"."
---
