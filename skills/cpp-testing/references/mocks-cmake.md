# Mocks, CMake/CTest, Running, Debugging
...
Use `gtest_discover_tests()` for stable test discovery. Separate unit vs integration tests in CTest labels or directories.
