...
description: "Use when build MCP servers with Node/TypeScript SDK — tools, resources, prompts, Zod validation, stdio vs Streamable HTTP. Use Context7 or official MCP docs for latest API. Triggers on \"mcp-server-patterns\", \"mcp server patterns\", \"patterns\"."
metadata:
  origin: ECC
---
