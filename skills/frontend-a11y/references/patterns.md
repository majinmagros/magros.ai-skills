# Patterns — Frontend Accessibility (código completo)

Exemplos BAD/GOOD completos: form login, dropdown custom, modal com focus restoration, imagens/ícones, reduced motion, anti-patterns. Resumo e checklist no `SKILL.md`.
...
## Custom Dropdown (keyboard: ArrowUp/Down, Enter/Space, Escape)
...
> Initial focus + restoration. For a full focus trap (Tab/Shift+Tab cycling), use [`focus-trap-react`](https://github.com/focus-trap/focus-trap-react).
