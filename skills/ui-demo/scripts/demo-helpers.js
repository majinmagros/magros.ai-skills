// demo-helpers.js — Helpers Playwright para demos: ensureVisible, cursor, moveAndClick,
// typeSlowly, panElements, injectSubtitleBar, showSubtitle
// Extraído de SKILL.md (2026-09-09). Copie para o script de demo.
...
module.exports = { ensureVisible, injectCursor, moveAndClick, typeSlowly, panElements, injectSubtitleBar, showSubtitle };
