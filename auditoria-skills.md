...
- **SKILL.md >200 linhas:** 91 (19.8%) | >500 linhas: 0
- **Com progressive disclosure (references/scripts):** 136 / 459 (29.6%) — 85% sao monolitos
- **Distribuicao por faixa:** 0-19:0 | 20-39:0 | 40-59:0 | 60-79:41 | 80-99:196
- **Conclusao:** Corpus sofre de **inflacao quantitativa** (459 pastas) sem curadoria de foco; 19.8% violam regra de ouro <=200 linhas e 0.0% nao disparam por falta de gatilho. Qualidade media aceitavel, mas cauda longa de skills fracas arrasta discoverability.
...
| Monolitos >200 linhas | 91 skills | Custo tokens alto, sem disclosure | Fatiar e mover para references/ |
| Mega-monolitos >500 linhas | 0 skills | Impossivel manter | Quebrar em 2-4 skills focadas |
| Sem progressive disclosure | 323 sem references/scripts | Tudo no SKILL.md | Criar references/ |
...
| 8 | **73** | 471 | `django-verification` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 9 | **73** | 378 | `error-handling` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 10 | **73** | 449 | `flutter-dart-code-review` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 11 | **73** | 383 | `intent-driven-development` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | desc longa; 350-500 linhas; sem disclosure |
| 12 | **73** | 385 | `java-coding-standards` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 13 | **73** | 417 | `laravel-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 14 | **73** | 435 | `motion-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 15 | **73** | 414 | `mysql-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 16 | **73** | 402 | `prisma-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 17 | **73** | 398 | `pytorch-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 18 | **73** | 425 | `react-testing` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 19 | **73** | 405 | `redis-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 20 | **73** | 467 | `ui-demo` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 21 | **73** | 451 | `vite-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | 350-500 linhas; sem disclosure |
| 22 | **74** | 223 | `configure-ecc` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar; >200 linhas; sem disclosure |
| 23 | **74** | 217 | `financiamento-imobiliario` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar; >200 linhas |
| 24 | **74** | 230 | `ito-basket-compare` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar; >200 linhas; sem disclosure |
| 25 | **76** | 341 | `android-clean-architecture` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | >200 linhas; sem disclosure |
| 26 | **76** | 304 | `autonomous-agent-harness` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | desc longa; >200 linhas; sem disclosure |
| 27 | **76** | 301 | `compose-multiplatform-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | >200 linhas; sem disclosure |
| 28 | **76** | 326 | `cpp-testing` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | >200 linhas; sem disclosure |
| 29 | **76** | 323 | `csharp-testing` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | >200 linhas; sem disclosure |
| 30 | **76** | 323 | `dotnet-patterns` | projeto | Extrair exemplos para references/ e scripts/, manter SKILL.md <=200 linhas | >200 linhas; sem disclosure |
...
### Faixa 60-79 (Regular - 41 skills)
Amostra: `e2e-testing`(66), `agentic-os`(73), `ai-regression-testing`(73), `clickhouse-io`(73), `database-migrations`(73), `deployment-patterns`(73), `django-celery`(73), `django-verification`(73), `error-handling`(73), `flutter-dart-code-review`(73) ...

### Faixa 80-99 & 100 (Boa/Excelente - 418 skills)
Amostra 100pts: `accessibility`, `agent-browser`, `agent-cost-optimization-batch`, `agent-eval`, `agent-introspection-debugging`, `agent-self-evaluation`, `agent-swarm-ops`, `agnostic-repo-mirror`, `ai-governance-monitor`, `api-connector-builder`, `api-design`, `architecture-decision-records`, `automation-audit-ops`, `autonomous-loops`, `autopilot-content-factory` ... (222 com 100pts)
