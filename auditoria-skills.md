...
- **Media geral:** 99.0/100 (boa — acima do 80 desejavel para corpus premium)
...
- **Distribuicao por faixa:** 0-19:0 | 20-39:0 | 40-59:0 | 60-79:0 | 80-99:67
...
|---|---|---|---|---|---|---|
| 1 | **93** | 65 | `knowledge-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 2 | **93** | 65 | `latency-critical-systems` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 3 | **93** | 57 | `llm-leaderboard-tracker` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar |
| 4 | **93** | 38 | `local-ai-hardware` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 5 | **93** | 41 | `local-llm-efficiency` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 6 | **93** | 65 | `loop-design-check` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 7 | **93** | 65 | `manim-video` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 8 | **93** | 65 | `market-research` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 9 | **93** | 65 | `marketing-campaign` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 10 | **93** | 65 | `mcp-hardware-arduino` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 11 | **93** | 65 | `meeting-task-listener` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 12 | **93** | 65 | `messages-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 13 | **93** | 58 | `ml-adoption-playbook` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 14 | **93** | 65 | `mle-workflow` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 15 | **93** | 65 | `model-migration-strategy` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 16 | **93** | 65 | `motion-advanced` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 17 | **93** | 65 | `motion-foundations` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 18 | **93** | 65 | `multi-perspective-convergence` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 19 | **93** | 59 | `n8n-agentic-flows` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 20 | **93** | 40 | `notebooklm-claude-rag` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 21 | **93** | 65 | `nutrient-document-processing` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 22 | **93** | 65 | `openclaw-persona-forge` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 23 | **93** | 65 | `orch-pipeline` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 24 | **93** | 65 | `parallel-execution-optimizer` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 25 | **93** | 65 | `perl-security` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 26 | **93** | 55 | `pipeline-video-agente` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 27 | **93** | 40 | `plain-language-response` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 28 | **93** | 65 | `plan-duel` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 29 | **93** | 65 | `prediction-market-oracle-research` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 30 | **93** | 65 | `product-capability` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
