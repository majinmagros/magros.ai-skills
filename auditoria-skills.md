...
- **Media geral:** 98.3/100 (boa — acima do 80 desejavel para corpus premium)
...
- **Distribuicao por faixa:** 0-19:0 | 20-39:0 | 40-59:0 | 60-79:0 | 80-99:109
...
|---|---|---|---|---|---|---|
| 1 | **93** | 30 | `claude-voice-workflow` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 2 | **93** | 40 | `cloud-code-internal-tools` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 3 | **93** | 27 | `cloud-code-vps-deploy` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 4 | **93** | 65 | `competitive-platform-analysis` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 5 | **93** | 65 | `competitive-report-structure` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 6 | **93** | 65 | `connections-optimizer` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 7 | **93** | 65 | `constituicao-projeto` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar |
| 8 | **93** | 65 | `content-engine` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 9 | **93** | 65 | `context-budget` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 10 | **93** | 65 | `context-ledger` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar |
| 11 | **93** | 47 | `continuous-agent-loop` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 12 | **93** | 52 | `criar-campanha-visual` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 13 | **93** | 65 | `crosspost` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 14 | **93** | 65 | `customer-billing-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 15 | **93** | 65 | `dashboard-builder` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 16 | **93** | 65 | `data-throughput-accelerator` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 17 | **93** | 65 | `delivery-gate` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 18 | **93** | 65 | `design-iterate-in-place` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 19 | **93** | 65 | `dm-keyword-automation` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 20 | **93** | 65 | `dnb-production` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar |
| 21 | **93** | 65 | `doctor` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 22 | **93** | 65 | `documentation-lookup` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 23 | **93** | 65 | `ecc-tools-cost-audit` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 24 | **93** | 65 | `email-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 25 | **93** | 65 | `engenharia-de-grafos` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 26 | **93** | 65 | `finance-billing-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 27 | **93** | 65 | `frontend-design-direction` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 28 | **93** | 65 | `frontend-slides` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 29 | **93** | 65 | `gauntlet-loop` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar |
| 30 | **93** | 65 | `gemini-cli-agent-skills` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
