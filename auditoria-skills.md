...
- **Media geral:** 100.0/100 (boa — acima do 80 desejavel para corpus premium)
...
- **Distribuicao por faixa:** 0-19:0 | 20-39:0 | 40-59:0 | 60-79:0 | 80-99:0
...
|---|---|---|---|---|---|---|
| 1 | **100** | 74 | `12-factor-agents` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 2 | **100** | 37 | `9router-gateway` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 3 | **100** | 39 | `9router-resilient-fallback` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 4 | **100** | 74 | `a2a-interoperability` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 5 | **100** | 65 | `accessibility` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 6 | **100** | 74 | `ads-creative-factory` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 7 | **100** | 73 | `ads-operator` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 8 | **100** | 73 | `ads-reporter-multi` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 9 | **100** | 74 | `aeo-geo-visibility` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 10 | **100** | 50 | `agent-architecture-audit` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 11 | **100** | 65 | `agent-browser` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 12 | **100** | 74 | `agent-commerce-interface` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 13 | **100** | 74 | `agent-cost-optimization-batch` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 14 | **100** | 65 | `agent-eval` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 15 | **100** | 74 | `agent-guardrails` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 16 | **100** | 86 | `agent-harness-construction` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 17 | **100** | 65 | `agent-introspection-debugging` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 18 | **100** | 49 | `agent-payment-x402` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 19 | **100** | 65 | `agent-self-evaluation` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 20 | **100** | 48 | `agent-sort` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 21 | **100** | 65 | `agent-swarm-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 22 | **100** | 84 | `agentic-engineering` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 23 | **100** | 59 | `agentic-os` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 24 | **100** | 65 | `agnostic-repo-mirror` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 25 | **100** | 72 | `ai-first-engineering` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 26 | **100** | 65 | `ai-governance-monitor` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 27 | **100** | 44 | `ai-media-generator` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 28 | **100** | 61 | `ai-regression-testing` | projeto | Revisar descricao e adicionar 1 exemplo copiavel |  |
| 29 | **100** | 65 | `ai-tutor-system` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
| 30 | **100** | 74 | `alpaca-broker-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa |
