...
- **Media geral:** 97.6/100 (boa — acima do 80 desejavel para corpus premium)
...
- **Distribuicao por faixa:** 0-19:0 | 20-39:0 | 40-59:0 | 60-79:0 | 80-99:147
...
|---|---|---|---|---|---|---|
| 1 | **86** | 53 | `routines` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar; sem exemplos |
| 2 | **86** | 56 | `search-hallucination-detection` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar; sem exemplos |
| 3 | **86** | 36 | `superpowers` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar; sem exemplos |
| 4 | **86** | 65 | `triagem-bug` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar; sem exemplos |
| 5 | **86** | 54 | `workflows` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar; sem exemplos |
| 6 | **87** | 29 | `9router-gateway` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar; pouca estrutura |
| 7 | **87** | 65 | `ito-compute` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar; pouca estrutura |
| 8 | **87** | 44 | `remotion-video-creation` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos; pouca estrutura |
| 9 | **93** | 65 | `12-factor-agents` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 10 | **93** | 65 | `a2a-interoperability` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 11 | **93** | 65 | `ads-creative-factory` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 12 | **93** | 65 | `ads-operator` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 13 | **93** | 65 | `ads-reporter-multi` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 14 | **93** | 65 | `aeo-geo-visibility` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 15 | **93** | 65 | `agent-commerce-interface` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 16 | **93** | 65 | `agent-cost-optimization-batch` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 17 | **93** | 65 | `agent-guardrails` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 18 | **93** | 35 | `ai-media-generator` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 19 | **93** | 65 | `alpaca-broker-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 20 | **93** | 65 | `angular-developer` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 21 | **93** | 65 | `api-connector-builder` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 22 | **93** | 65 | `approval-loop-morning-digest` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 23 | **93** | 65 | `article-writing` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 24 | **93** | 65 | `astro-site-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 25 | **93** | 65 | `auditoria-cientifica-ia` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar |
| 26 | **93** | 65 | `autobots-auto-improvement` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | desc longa; sem secao Quando Ativar |
| 27 | **93** | 65 | `automation-audit-ops` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | sem exemplos |
| 28 | **93** | 65 | `avaliar-ferramenta-ia` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
| 29 | **93** | 65 | `baixar-musica` | projeto | Adicionar secao ## Quando Ativar com 4-5 gatilhos literais | sem secao Quando Ativar |
| 30 | **93** | 65 | `benchmark-methodology` | projeto | Revisar descricao e adicionar 1 exemplo copiavel | desc longa; sem exemplos |
...
Amostra 100pts: `9router-resilient-fallback`, `accessibility`, `agent-architecture-audit`, `agent-browser`, `agent-eval`, `agent-harness-construction`, `agent-introspection-debugging`, `agent-payment-x402`, `agent-self-evaluation`, `agent-sort`, `agent-swarm-ops`, `agentic-engineering`, `agentic-os`, `agnostic-repo-mirror`, `ai-first-engineering` ... (312 com 100pts)
